 ...
 */
export default function CheckInCard({ onJoin, isJoining, canJoin, sessionId }) {
    return (
        <div className="w-full max-w-sm bg-white border border-slate-200 rounded-xl p-6 md:p-8 shadow-sm relative overflow-hidden">
            ...
            <div className="space-y-2 mb-8 mt-2">
                ...
                <p className="text-sm text-slate-500 leading-relaxed font-medium">
                    Reserve your virtual spot. We will notify you when it's time for your visit.
                </p>
            </div>
            ...
            <div className="space-y-6">
                ...
                <div className="flex items-center justify-between pt-5 border-t border-slate-100">
                    <div className="flex flex-col">
                        <span className="text-[9px] text-slate-400 uppercase tracking-[0.2em] font-bold font-display">Session ID</span>
                        <span className="text-[10px] font-mono text-slate-600 font-bold uppercase tracking-tighter mt-0.5">{sessionId || "QUE-X08"}</span>
                    </div>

                    <div className="text-right">
                        <span className="text-[9px] text-slate-400 uppercase tracking-[0.2em] font-bold font-display block">Verification</span>
            ...
            {!canJoin && !isJoining && (
                <div className="absolute inset-0 bg-white/80 backdrop-blur-[1px] flex items-center justify-center p-6 text-center z-20">
                    <div className="bg-white border border-slate-200 rounded-lg p-5 shadow-lg max-w-[200px]">
                        <p className="text-xs font-bold text-slate-900 uppercase tracking-widest">Service Standby</p>
                        <p className="text-[10px] text-slate-500 mt-2 font-medium">Remote token issuance is temporarily inactive.</p>
                    </div>
                </div>
            )}
        </div>
