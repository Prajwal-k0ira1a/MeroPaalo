export default function TokenSuccessCard({ token, institution }) {
    const trackingUrl = `/token-status?tokenId=${encodeURIComponent(token._id)}&institution=${encodeURIComponent(institution)}&tokenNumber=${encodeURIComponent(token.tokenNumber)}`;
            ...
            <div className="bg-white border border-slate-200 rounded-2xl p-8 md:p-10 shadow-sm text-center relative overflow-hidden">
                ...
                <div className="relative z-10">
                    <div className="inline-flex items-center gap-2 px-3 py-1 bg-teal-50 border border-teal-100 rounded-full mb-8">
                        ...
                        <span className="text-[10px] font-bold text-teal-700 uppercase tracking-widest font-display">Confirmation Token Issued</span>
                    </div>
                    ...
                    <div className="flex flex-col gap-2 mb-8">
                        <p className="text-sm font-semibold text-slate-800 tracking-tight">Your spot is reserved.</p>
