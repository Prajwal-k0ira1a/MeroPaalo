...
import { User, Mail, Lock, Eye, EyeOff, Building2, CheckCircle2 } from 'lucide-react';
...
export const SignUp = () => {
    const [formData, setFormData] = useState({
        fullName: '', institution: '', email: '', password: '', confirmPassword: ''
    });
    ...
    const strengthColor = ['', 'bg-red-500', 'bg-amber-500', 'bg-blue-500', 'bg-teal-500'][strength];
                    ...
                    <form onSubmit={handleSubmit} className="space-y-3">
                            ...
                            <div className="grid grid-cols-3 gap-2">
                                {ROLES.map(r => (
                                    <button
                                        ...
                                        type="button"
                                        onClick={() => setRole(r)}
                                        className={`py-2.5 rounded-xl border text-sm font-semibold transition-all duration-200 ${role === r
                        ...
                        <div className="w-full">
                            <label className="block text-sm font-semibold text-gray-800 mb-2">
                                Confirm Password
                                {passwordsMatch && (
                                    <CheckCircle2 size={14} className="inline ml-2 text-teal-500" />
                                )}
                            </label>
                            <div className="relative">
                                <div className="absolute left-4 top-1/2 -translate-y-1/2 text-gray-400 pointer-events-none">
                                ...
                                <input
                                    ...
                                    onChange={handleChange}
                                    required
                                    className={`w-full py-3 px-4 pl-11 pr-11 border-2 rounded-xl text-gray-900 placeholder-gray-400 text-sm transition-all duration-200 focus:outline-none ${formData.confirmPassword && !passwordsMatch
                        ...
                        <label className="flex items-start gap-2.5 cursor-pointer mt-1">
                            ...
                            <span className="text-sm text-slate-500 leading-relaxed">
                                I agree to the{' '}
                                <a href="#" className="text-teal-600 font-semibold hover:text-teal-700">Terms of Service</a>
                                {' '}and{' '}
                                <a href="#" className="text-teal-600 font-semibold hover:text-teal-700">Privacy Policy</a>
                            </span>
                        </label>
                        ...
                        <Button
                            ...
                            size="lg"
                            className="w-full"
                            disabled={isLoading || !agreed || (formData.confirmPassword && !passwordsMatch)}
                        >
